...
use crate::{
    Array, ArrayOfTables, Datetime, DocumentMut, Formatted, InlineTable, Integer, Item, KeyMut,
...
pub trait VisitMut {
    ...
    fn visit_integer_mut(&mut self, node: &mut Formatted<Integer>) {
...
empty_visit_mut!(visit_integer_mut, Formatted<Integer>);
